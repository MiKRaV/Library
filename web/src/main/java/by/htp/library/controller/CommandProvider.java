...
public class CommandProvider {
	...
	public CommandProvider() {
		...
		commands.put(START_APP_LOGINATION.getCommandName(), new StartAppCommand()); //NOT USED
		commands.put(START_APP_REGISTARTION.getCommandName(), new StartAppCommand()); //NOT USED
		...
		commands.put(GO_TO_USER_REMOVE_PAGE.getCommandName(), new GoToUserRemovePage()); //NOT USED
		commands.put(GO_TO_START_PAGE.getCommandName(), new GoToStartPage()); //NOT USED
		commands.put(GO_TO_USER_DATA_PAGE.getCommandName(), new GoToUserDataPageCommand()); //NOT USED
		commands.put(GO_TO_SEARCH_PAGE.getCommandName(), new GoToSearchUserPageCommand()); //NOT USED
		...
		commands.put(GO_TO_ADDING_BOOK_PAGE.getCommandName(), new GoToAddingBookPage()); //NOT USED
		...
		commands.put(GET_ORDERS.getCommandName(), new GetOrdersCommand());
		commands.put(CLEAR_BASKET.getCommandName(), new ClearBasketCommand());
		commands.put(CREATE_ORDER.getCommandName(), new CreateOrderCommand());
		commands.put(GET_ORDER_INFO.getCommandName(), new GetOrderInfoCommand());
		commands.put(CHANGE_ORDER_STATUS.getCommandName(), new ChangeOrderStatusCommand());
	}
